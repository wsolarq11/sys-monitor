...
class TestRunnerAgent(AsyncAgentBase):
    ...
    async def run_tests(self, config) -> Dict[str, Any]:
        ...
        failures = await self.analyze_failures(unit_result, integration_result, e2e_result)
        ...
        await self._publish_event("completed", {
            "total_passed": total_passed,
            "total_failed": total_failed
        })
    ...
    async def diagnose_failure(self, failure_info: Dict[str, Any]) -> List[Dict[str, Any]]:
        """

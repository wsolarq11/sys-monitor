...
class SpecWatcher:
    ...
    def __init__(self, project_root: str = None):
        ...
        self.log_path = os.path.join(self.project_root, '.lingma', 'logs', 'watcher.log')
        self.state_path = os.path.join(self.project_root, '.lingma', 'worker', 'watcher-state.json')
        self.config_path = os.path.join(self.project_root, '.lingma', 'config', 'watcher-config.json')

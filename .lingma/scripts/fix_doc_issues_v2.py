...
def remove_empty_files():
    ...
    empty_files = [
        os.path.join(
            project_root, ".lingma", "docs", "reports", "ARCHITECTURE-FIX-PLAN.md"
        ),
        os.path.join(
            project_root,
            ".lingma",
    ...
    duplicates = [
        {
            "files": [
                os.path.join(
                    project_root, ".lingma", "docs", "spec-trigger-hard-constraint.md"
                ),
                os.path.join(
                    project_root,
                    ".lingma",
                    "docs",
                    "guides",
                    "spec-trigger-hard-constraint.md",
                ),
            ],
        ...
        },
        {
            "files": [
                ...
                os.path.join(
                    project_root, ".lingma", "docs", "guides", "QUICK_START.md"
                ),
            ],
            "recommendation": "保留guides版本，删除根目录版本",
        },
        ...
        (
            ...
            [
                ...
                os.path.join(
                    ...
                    "docs",
                    "skills",
                    "spec-driven-development-detailed.md",
                ),
            ],
        ),
        (

...
### P0 - 核心规则（Always Apply）

#### 1. [AGENTS.md](../rules/AGENTS.md) ⭐
...
### P1 - 高优先级规则（Project Rules）

#### 2. [automation-policy.md](../rules/automation-policy.md)
...
#### 3. [memory-usage.md](../rules/memory-usage.md)
...
### P2 - 工作流触发器（Workflow Triggers）

#### 4. [spec-session-start.md](../rules/spec-session-start.md)
...
### 规则层级
```
P0: Always Apply (AGENTS.md)
    ↓
P1: Project Rules (automation-policy.md, memory-usage.md)
    ↓
P2: Workflow Triggers (spec-session-start.md)
```
...
| 类别 | 数量 | 状态 |
|------|------|------|
| P0 - Always Apply | 1 | ✅ Active |
| P1 - Project Rules | 2 | ✅ Active |
| P2 - Workflow Triggers | 1 | ✅ Active |
| **总计** | **4** | **✅ All Active** |
...
- **2026-04-15**: 合并 rules-registry.md 和 RULES_INDEX.md，统一规则管理
- 遵循渐进式披露原则，仅列出必要信息
